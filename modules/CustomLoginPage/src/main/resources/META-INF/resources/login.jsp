...
<h1>Hello</h1>
        ...
        <div class="login-container">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <img src="http://localhost:8080/documents/d/marketplacesite/cemex-loginpage" alt="cemexLogo">
                    </div>
                    <div class="col-md-4">
                        <aui:form action="<%= loginURL %>"
                            ...
                            <liferay-ui:error exception="<%= UserLockoutException.PasswordPolicyLockout.class %>">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <liferay-ui:message arguments="<%= dateFormat.format(ule.user.getUnlockDate()) %>"
                            ...
                            <aui:fieldset>
                                ...
                                <span id="<portlet:namespace />passwordCapsLockSpan" style="display: none;"><liferay-ui:message
